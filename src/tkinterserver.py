"""
Change the correct answer represenation.
Add the questions.
make name ubique(?)
if answer is.nt present - take care.
repeated games?
tie handling.


note: 
For every correct answer +10
Every wrong answer -5
"""
...
def player2(conn):
    ...
    #ans_list.append("correct ans")

#structure of answers dictionary: {onu:hi,meg:ki,did not get psyched:bu}
...
if __name__ == '__main__':
    #q = queue.Queue() #To synchronize parent and consumer threads
    host = '127.0.0.1' 
    port = 59624
    ans_list=[]
    player_scores = {}
    ...
    playerinfo = {}
    question_no = 0
    #question_list = ["Whats dog's name","Whats cat's name","Whats feti's name"]
    #correct_ans = ["dog","cat","fati"]
    question_list = ["Whats dog's name"]
    correct_ans = ["dog"]
